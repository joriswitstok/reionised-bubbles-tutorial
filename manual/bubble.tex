...
\begin{problem}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item If roughly two out of three of recombination events lead to the emission of a \Lya photon (in the ionisation-bounded case), what is the \Lya luminosity of the cloud? How does this compare to the bolometric luminosity of the central star $L_\text{bol}$, if assumed to be a perfect blackbody (hint: derive $L_\text{bol}$ based on the size mentioned above and the Stefan-Boltzmann law)?
    \end{enumerate}
\end{problem}
...
\subsection{Visualise the environment of the ionised bubble (optional)}
